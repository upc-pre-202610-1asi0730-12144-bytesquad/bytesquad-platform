...
public static class MaintenanceLogActionResultAssembler
{
    private static int MapErrorToStatusCode(Enum error) => error switch
    {
        MaintenanceLogError.TechnicalTicketNotFound => StatusCodes.Status404NotFound,
        MaintenanceLogError.TicketNotResolved => StatusCodes.Status400BadRequest,
