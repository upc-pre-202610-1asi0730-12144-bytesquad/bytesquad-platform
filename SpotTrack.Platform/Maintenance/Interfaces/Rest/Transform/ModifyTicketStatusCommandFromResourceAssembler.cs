...
{
    public static ModifyTicketStatusCommand ToCommandFromResource(int ticketId, int adminId, ModifyTicketStatusResource resource) =>
        new(ticketId, Enum.Parse<ETechnicalTicketStatus>(resource.NewStatus, ignoreCase: true), adminId);
}
