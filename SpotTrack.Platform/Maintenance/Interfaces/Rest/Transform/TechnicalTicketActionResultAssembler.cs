...
public static class TechnicalTicketActionResultAssembler
{
    private static int MapErrorToStatusCode(Enum error) => error switch
    {
        TechnicalTicketError.TechnicalTicketNotFound or
            TechnicalTicketError.MaintenanceNotFound => StatusCodes.Status404NotFound,
        TechnicalTicketError.InvalidTechnicalTicketStatus or
            TechnicalTicketError.EquipmentUpdateFailed => StatusCodes.Status400BadRequest,
