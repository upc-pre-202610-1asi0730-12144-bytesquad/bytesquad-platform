...
public record TicketStatusModifiedEvent(
    int TechnicalTicketId,
    ETechnicalTicketStatus NewStatus) : IEvent
{
    public static TicketStatusModifiedEvent FromTechnicalTicket(TechnicalTicket ticket) =>
        new(ticket.Id, ticket.Status);
}
