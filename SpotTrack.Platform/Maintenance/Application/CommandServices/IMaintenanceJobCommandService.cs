...
public interface IMaintenanceJobCommandService
{
    Task<Result<MaintenanceJob>> Handle(CreateAcceptMaintenanceCommand command, CancellationToken cancellationToken);
}
