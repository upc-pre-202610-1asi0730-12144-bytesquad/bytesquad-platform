...
public static class DowngradeMembershipPlanCommandFromResourceAssembler
{
    public static CreateDowngradeMembershipPlanCommand ToCommandFromResource(
        int membershipId,
        DowngradeMembershipPlanResource resource) =>
