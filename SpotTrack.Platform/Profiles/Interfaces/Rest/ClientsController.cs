    ...
    ProblemDetailsFactory problemDetailsFactory) : ControllerBase
{
    ...
    [SwaggerOperation(
        ...
        Description = "Associates the currently authenticated client with a gym after validating their DNI against the gym's whitelist. The first association becomes the active gym automatically.",
    ...
    [SwaggerResponse(StatusCodes.Status403Forbidden, "DNI not authorised for this gym")]
    [SwaggerResponse(StatusCodes.Status404NotFound, "Client profile not found")]
    ...
    public async Task<IActionResult> GetMyGymAssociations(CancellationToken cancellationToken)
    {
        ...
        return Ok(associations.Select(ClientGymAssociationResourceFromEntityAssembler.ToResourceFromEntity));
    }
    ...
    [SwaggerOperation(
        ...
        Description = "Returns the client profile matching the given ID. Admin only.",
    ...
    [SwaggerOperation(
        ...
        Description = "Returns the list of all registered client profiles. Admin only.",
    ...
    public async Task<IActionResult> GetAllClients(CancellationToken cancellationToken)
    {
        ...
        return Ok(clients.Select(ClientResourceFromEntityAssembler.ToResourceFromEntity));
    }
    ...
    [SwaggerOperation(
        ...
        Description = "Updates the first name, last name and phone number of the given client. Admin only.",
