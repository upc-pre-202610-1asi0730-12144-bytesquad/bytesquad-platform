...
public class ClientQueryService(
    ...
    IClientGymAssociationRepository clientGymAssociationRepository) : IClientQueryService
{
    ...
    public async Task<IEnumerable<ClientGymAssociation>> Handle(GetClientGymAssociationsQuery query, CancellationToken cancellationToken)
